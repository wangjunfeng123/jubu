 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://server.webservice.test.jubu.ninep.com/", wsdlLocation = "http://localhost:8888/jubu/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://server.webservice.test.jubu.ninep.com/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/jubu/hello?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://server.webservice.test.jubu.ninep.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.test.jubu.ninep.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
